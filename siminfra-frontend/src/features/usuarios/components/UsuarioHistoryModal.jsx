...
export default function UsuarioHistoryModal({
  usuario,
  onClose,
}) {
      ...
      >
        ...
        >
          ...
          usuario.historial.length > 0 ? (
            ...
            >
              {usuario.historial.map((historial, index) => {
                const isExpanded =
            ...
            >
              No existen registros de modificaciones para este usuario.
            </p>
          )}
        </div>
      </div>
