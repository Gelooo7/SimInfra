...
export default function PCGenericoHistoryModal({
  pc,
  onClose,
}) {
      ...
      >
        ...
        >
          {pc.historial &&
            ...
            >
              {pc.historial.map((historial, index) => {
                const isExpanded =
            ...
            >
              No existen registros de cambios para este PC Genérico.
            </p>
          )}
        </div>
      </div>
